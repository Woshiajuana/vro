...
export const UI_ROOT_DIR = path.join(CWD_DIR, '..', 'horn-ui')
export const UI_DOCS_DIR = path.join(UI_ROOT_DIR, 'docs')
export const UI_SRC_DIR = path.join(UI_ROOT_DIR, 'src')

export const USE_ROOT_DIR = path.join(CWD_DIR, '..', 'horn-use')
export const USE_SRC_DIR = path.join(USE_ROOT_DIR, 'src')

export const JSSDK_ROOT_DIR = path.join(CWD_DIR, '..', 'horn-jssdk')
