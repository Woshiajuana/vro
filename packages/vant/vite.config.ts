...
export default defineConfig({
  ...
  build: {
    ...
    rollupOptions: {
      external: [/^@daysnap\//, /^@vrojs\//, /^vant/, /^vue/],
      output: {
...
function injectCssImports() {
  return {
    ...
    // 这样用户 import '@vrojs/vant/xxx/style/css' 时可以真正带上组件样式。
...
function getCssEntry(fileName: string) {
  ...
  // dist/vro-van-x/style/css.js -> src/vro-van-x/style/css.ts
...
function toCssAsset(scssFile: string) {
  // src/vro-van-x/style/index.scss -> vro-van-x/style/index.css
